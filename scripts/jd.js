...
} else if (url.includes("functionId=cart") || url.includes("functionId=subCartCount") || url.includes("functionId=asynInteface") || url.includes("functionId=newPurchaseWareCheck") || url.includes("functionId=wait4Delivery")) {
    if (obj?.wait) {
      obj.wait = 0;
  }
}
