...
obj.data.modules.attractGalleryInfo.data.list = [];
    ...
    if (obj?.data?.modules?.poiDetailBottomBar?.data?.hotel) {
obj.data.modules.poiDetailBottomBar.data.hotel = [];
 }
